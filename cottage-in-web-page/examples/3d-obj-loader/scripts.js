...
var keyLight = new THREE.DirectionalLight(new THREE.Color('#FFFFE5'), 0.5);
 keyLight.position.set(-100, 180, 100);

//var fillLight = new THREE.DirectionalLight(new THREE.Color('hsl(240, 100%, 75%)'), 0.75);
 var fillLight = new THREE.DirectionalLight(new THREE.Color('#FFFFE5'), 0.75);
 fillLight.position.set(100, 180, 120);
